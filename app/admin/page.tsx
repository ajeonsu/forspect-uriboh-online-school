  ...
  return (
    <>
      ...
      <div className="admin-stat-grid">
        <Stat label="Lessons" value={stats.totalLessons} href="/admin/lessons" />
        ...
        <Stat label="Categories" value={stats.totalGenres} href="/admin/categories" />
        <Stat label="Seminars" value={stats.totalSeminars} href="/admin/seminars" />
        <Stat label="Pending seminars" value={stats.pendingSeminars} href="/admin/seminars?moderation=pending" />
        {!stats.isContributorView && (
          <>
            <Stat label="Users" value={stats.totalUsers} href="/admin/users" />
                ...
                {stats.recentEdits.map((l) => (
                  <tr key={l.id}>
                    <td className="admin-table__title">
                      <Link href={`/admin/lessons/${l.id}/edit`}>{l.title}</Link>
                    </td>
                    <td>
